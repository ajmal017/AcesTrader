  ...
  render() {
    ...
    return (
      <div>
        ...
        <button onClick={myFunction}>Get Symbols</button>

        <h2>Buy on the dip</h2>
        <table className="table mm-mobile-table" id="myTable">
          <thead>
            <tr>
              <th>Ticker</th>
              <th>Name</th>
          ...
          <tbody>
            <tr>
              <td data-th="Ticker">
                ...
                <span className="rating-circle">B</span>)
              </td>
            ...
            <tr>
              <td data-th="Ticker">
                ...
                <span className="rating-circle">A</span>)
              </td>
