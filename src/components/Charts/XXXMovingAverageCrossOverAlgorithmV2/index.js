// MovingAverageCrossOverAlgorithmV2/index.js
...
class MovingAverageCrossOverAlgorithmV2 extends React.Component {
  render() {
    const ema20 = ema()
      .id(0)
      .options({ windowSize: 13 }) // optional will default to 10
      .merge((d, c) => {
        d.ema20 = c
      })
      .accessor((d) => d.ema20)
    ...
    return (
      <ChartCanvas
        ...
        xExtents={xExtents}>
        <Chart id={chartId + '1'} yExtents={[(d) => [d.high, d.low], ema20.accessor(), ema50.accessor()]} padding={{ top: 10, bottom: 20 }}>
