...
export default function(state, theInputObject, theIndex = null) {
  // Parameters:
  ...
  if (theIndex === null) {
    ...
    // theInputObject: An object to replace existing object in this target state
    ...
    newState[theIndex] = theInputObject
    //console.log(JSON.stringify(newState, null, 2)) // a readable log of the object's json
    return newState
  }
}
